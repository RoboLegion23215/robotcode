...
public class InverseKinematicsV4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (arm.getCurrentPosition() > 0 && hanger.getCurrentPosition() > 0 && arm.getCurrentPosition() < 2100 && hanger.getCurrentPosition() < 2100) {
