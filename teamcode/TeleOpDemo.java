...
public class TeleOpDemo extends LinearOpMode {
    ...
    private final double wristDownTwo = 0.25;
    ...
    private final double leftClawDown = 0.19;

    private final double rightClawUp = 1.0;

    private final double rightClawDown = 0.75;
    double armSpeed;
    double lfSpeed;
    double rfSpeed;
    double lbSpeed;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            leftFront.setPower(lfSpeed * 0.5);
            leftBack.setPower(lbSpeed * 0.5);
            rightFront.setPower(rfSpeed * 0.5);
            rightBack.setPower(rbSpeed * 0.5);
