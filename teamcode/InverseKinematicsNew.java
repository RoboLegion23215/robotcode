...
@TeleOp(name = "Inverse Kinematics New")


public class InverseKinematicsNew extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (arm.getCurrentPosition() > 2100 && hanger.getCurrentPosition() > 2100) {
                ...
                wrister.setPosition(0.95 - ((arm.getCurrentPosition() - 2100)/ 3895.88088));
